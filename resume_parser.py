...
# CONNECT TO DATABASE
connection = pymysql.connect(host='localhost', user='root', password='Maurya@2003')
cursor = connection.cursor()

# Create the 'cv' database if it doesn't exist
cursor.execute("CREATE DATABASE IF NOT EXISTS cv")

# Select the 'cv' database
...
st.set_page_config(
    ...
    page_icon="C:\\Users\\Dell\\Downloads\\Untitled Folder\\logo2.png"
)


def run():
    img = Image.open('C:\\Users\\Dell\\Downloads\\Untitled Folder\\logo2.png')
    st.image(img)
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            with st.spinner('Uploading your Resume...'):
                time.sleep(4)
            save_image_path = "C:/Users/Dell/Downloads/Untitled Folder/Uploaded_Resumes/" + pdf_file.name
